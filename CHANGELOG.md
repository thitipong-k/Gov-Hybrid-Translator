...
### แก้ไข (Fixed)
- **Plugin Details Screenshots**: ปรับปรุงระบบแปลงเนื้อหาสำหรับแท็บภาพตัวอย่าง โดยทำการแปลงหัวข้อที่เป็นข้อความเปล่า ๆ ให้สร้างเป็นแท็กรูปภาพ `<img>` จริง ๆ โดยดึงรูปภาพตรงตามลำดับจากที่เก็บภาพบน GitHub เพื่อแก้ไขปัญหาไฟล์รูปภาพไม่แสดงในหน้าต่างดูรายละเอียดอัปเดตของ WordPress
...
### ปรับปรุง (Improved)
- **Plugin Details Screenshots**: แก้ไขที่อยู่ลิงก์รูปภาพตัวอย่างให้ชี้ไปยังโฟลเดอร์ `assets/images/` ตรงตามตำแหน่งของไฟล์รูปภาพจริง (เช่น screenshot-1.png, screenshot-2.png เป็นต้น) ที่อยู่ในโปรเจกต์ เพื่อดึงภาพหน้าจอจริงไปแสดงผลบนเซิร์ฟเวอร์เว็บจริงผ่าน GitHub อย่างถูกต้องสมบูรณ์
...
### ปรับปรุง (Improved)
- **Plugin Details Screenshots**: ปรับปรุงหน้าต่างแสดงรายละเอียดภาพตัวอย่างปลั๊กอิน (Screenshots) โดยใช้เทคนิคการตรวจจับและแปลงลิงก์ CDN ของ WordPress.org ให้ชี้ไปยังคลังเก็บภาพในโฟลเดอร์ `assets/` ของ GitHub repository อัตโนมัติ ทำให้เว็บที่ใช้ Plugin Update Checker สามารถดึงและเปิดแสดงภาพหน้าจอตัวอย่างต่าง ๆ ได้จริงอย่างสวยงาม
