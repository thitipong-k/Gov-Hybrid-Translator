...
**Gov Hybrid Translator** เป็นปลั๊กอิน WordPress สำหรับแปลเนื้อหาเว็บไซต์ราชการ โดยรองรับหลายภาษา:
...
#### วิธีที่ 3: ใช้ AI แปลอัตโนมัติ

1. ไปที่ **Translation Tasks > Posts**
2. เว้นช่องว่าง (หรือพิมพ์ชื่อ)
3. คลิก **🤖 AI Translate**
4. ระบบแปลทั้ง Title และ Content
...
### การทำงานของ Glossary

```
ข้อความต้นฉบับ → AI แปล → แทนที่ด้วย Glossary → ผลลัพธ์สุดท้าย
```
